...
function eta_ai_visibility_llms_text($full = false)
{
    ...
    $lines = [
        ...
        '## Locations',
        '',
        '- [Karachi environmental laboratory](' . home_url('/karachi-environmental-lab/') . ') — PNAC LAB-285 applies only to the Karachi permanent premises and listed matrix, parameter, method, and range combinations.',
        ...
        '',
        '- [PNAC LAB-285 official scope](https://pnac.gov.pk/pdfFiles/LAB-285) — Karachi permanent laboratory; ISO/IEC 17025:2017; document states validity through 4 May 2029; only listed location, matrix, parameter, method, and range combinations are accredited.',
        '- [PNAC LAB-347 official scope](https://pnac.gov.pk/pdfFiles/LAB-347) — Lahore permanent laboratory; ISO/IEC 17025:2017; document states validity through 21 September 2028; only listed location, matrix, parameter, and method combinations are accredited.',
