...
<script type="module" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/eta-hero-twin.js?v=11" data-no-optimize="1" data-no-defer="1" data-litespeed-noopt="1"></script>
<style>
