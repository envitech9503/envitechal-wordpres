...
<script type="module" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/eta-hero-twin.js?v=12" data-no-optimize="1" data-no-defer="1" data-litespeed-noopt="1"></script>
<style>
...
.etb-proof strong { display: block; font-family: 'Outfit', sans-serif; font-weight: 300; font-size: clamp(19px, 1.8vw, 25px); letter-spacing: .1em; color: var(--etb-ink); margin-bottom: 8px; }
