...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_add_inline_style(
        'eta-modern',
        <<<'CSS'
.eta-chatbot-root{position:fixed;right:24px;bottom:24px;z-index:9999;color:#102229;font-family:inherit}.eta-chatbot-root[hidden],.eta-chatbot-panel[hidden],.eta-chatbot-frame-wrap[hidden],.eta-chatbot-fallback[hidden]{display:none!important}.eta-chatbot-panel{position:absolute;right:0;bottom:calc(100% + 18px);display:flex;flex-direction:column;width:min(420px,calc(100vw - 32px));height:min(650px,calc(100dvh - 126px));max-height:min(650px,calc(100dvh - 126px));border:1px solid rgba(16,34,41,.12);border-radius:16px;background:#fff;box-shadow:0 24px 64px rgba(16,34,41,.28);overflow:hidden}.eta-chatbot-panel-header{display:flex;flex:0 0 auto;align-items:center;justify-content:space-between;gap:16px;padding:13px 14px;background:linear-gradient(135deg,#102229,#184e44 58%,#006633);color:#fff}.eta-chatbot-panel-copy{min-width:0}.eta-chatbot-panel-kicker,.eta-chatbot-panel-summary{display:none}.eta-chatbot-panel-title{margin:0;color:#fff;font-size:1.05rem;font-weight:800;line-height:1.25}.eta-chatbot-close{display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;flex:0 0 auto;border:1px solid rgba(255,255,255,.25);border-radius:999px;background:rgba(255,255,255,.09);color:#fff;font-size:1.6rem;line-height:1;cursor:pointer}.eta-chatbot-close:hover,.eta-chatbot-close:focus-visible{background:rgba(255,255,255,.18)}.eta-chatbot-panel-body{display:flex;flex:1 1 auto;min-height:0;flex-direction:column;overflow:hidden;padding:10px 11px;background:#fff}.eta-chatbot-status{flex:0 0 auto;margin:0 0 8px;padding:8px 10px;border:1px solid rgba(29,107,79,.16);border-radius:8px;background:linear-gradient(135deg,rgba(29,107,79,.08),rgba(200,155,60,.08));color:#102229;font-size:.8rem;font-weight:700;line-height:1.35}.eta-chatbot-frame-wrap{display:flex;flex:1 1 auto;min-height:0;flex-direction:column;border:1px solid rgba(16,34,41,.1);border-radius:12px;overflow:hidden;background:#f7fbf8}.eta-chatbot-messages{display:flex;flex:1 1 auto;min-height:0;max-height:none;flex-direction:column;gap:10px;padding:12px;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable}.eta-chatbot-message{max-width:88%;padding:10px 12px;border-radius:12px;color:#183038;font-size:.9rem;line-height:1.5;overflow-wrap:anywhere}.eta-chatbot-message p{margin:0;white-space:pre-wrap}.eta-chatbot-message-assistant{align-self:flex-start;border:1px solid rgba(29,107,79,.16);border-bottom-left-radius:5px;background:#eef7f2}.eta-chatbot-message-user{align-self:flex-end;border-bottom-right-radius:5px;background:#102229;color:#fff}.eta-chatbot-citations{display:flex;flex-wrap:wrap;gap:6px;margin:9px 0 0;padding:0;list-style:none}.eta-chatbot-citations a{display:inline-flex;min-height:28px;align-items:center;padding:4px 9px;border:1px solid rgba(0,102,51,.2);border-radius:999px;background:#fff;color:#006633;font-size:.76rem;font-weight:700;line-height:1.2;text-decoration:none}.eta-chatbot-citations a:hover,.eta-chatbot-citations a:focus-visible{border-color:#006633;background:#f1faf5}.eta-chatbot-form{display:grid;flex:0 0 auto;grid-template-columns:minmax(0,1fr) auto;gap:8px;padding:10px;border-top:1px solid rgba(16,34,41,.09);background:#fff}.eta-chatbot-form textarea{box-sizing:border-box;width:100%;min-height:44px;max-height:108px;resize:none;border:1px solid rgba(16,34,41,.24);border-radius:12px;padding:10px 11px;background:#fff;color:#102229;font:inherit;font-size:16px;line-height:1.35}.eta-chatbot-form textarea:focus{border-color:#006633;box-shadow:0 0 0 3px rgba(0,102,51,.1);outline:0}.eta-chatbot-send{align-self:end;min-width:68px;min-height:44px;padding:8px 14px;border:0;border-radius:12px;background:#006633;color:#fff;font:inherit;font-weight:800;cursor:pointer}.eta-chatbot-send:hover,.eta-chatbot-send:focus-visible{background:#004d26}.eta-chatbot-send:disabled,.eta-chatbot-form textarea:disabled{cursor:not-allowed;opacity:.62}.eta-chatbot-fallback{margin-top:8px;padding:10px 12px;border:1px solid rgba(200,155,60,.34);border-radius:12px;background:linear-gradient(135deg,rgba(200,155,60,.12),rgba(29,107,79,.08))}.eta-chatbot-fallback p{margin:0 0 8px;color:#102229;font-size:.86rem;line-height:1.42}.eta-chatbot-actions{display:flex;flex-wrap:wrap;gap:8px}.eta-chatbot-action{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:6px 12px;border:1px solid #006633;border-radius:999px;color:#006633;font-size:.84rem;font-weight:800;text-decoration:none}.eta-chatbot-action-primary{background:#006633;color:#fff}.eta-chatbot-panel-footer{flex:0 0 auto;padding:10px 14px 12px;border-top:1px solid rgba(16,34,41,.07);background:#fff}.eta-chatbot-footer-link{color:#006633;font-size:.82rem;font-weight:700;text-decoration:none}.eta-chatbot-root[data-eta-busy="true"] .eta-chatbot-status:before{content:"";display:inline-block;width:8px;height:8px;margin-right:7px;border-radius:50%;background:#c89b3c;animation:eta-chatbot-pulse 1s ease-in-out infinite}.eta-chatbot-root.is-open .eta-chatbot-launcher{visibility:hidden;pointer-events:none}@keyframes eta-chatbot-pulse{50%{opacity:.32}}@media(max-width:640px){body.eta-chatbot-open{overflow:hidden}.eta-chatbot-root{right:10px;bottom:max(16px,env(safe-area-inset-bottom))}.eta-chatbot-launcher{width:58px;height:58px}.eta-chatbot-panel{right:-2px;bottom:calc(100% + 10px);width:calc(100vw - 16px);height:min(700px,calc(100dvh - 96px));max-height:calc(100dvh - 96px);border-radius:16px}.eta-chatbot-panel-body{padding:8px}.eta-chatbot-status{margin-bottom:7px}.eta-chatbot-messages{padding:10px}.eta-chatbot-message{max-width:92%;font-size:.88rem}.eta-chatbot-form{padding:8px}.eta-chatbot-panel-footer{padding:9px 12px 10px}}@media(prefers-reduced-motion:reduce){.eta-chatbot-root[data-eta-busy="true"] .eta-chatbot-status:before{animation:none}}
...
add_filter('language_attributes', function ($output) {
    $output = preg_replace('/\blang=("[^"]*"|\'[^\']*\')/i', 'lang="en-GB"', (string) $output, 1);
    return strpos((string) $output, 'lang=') === false ? trim((string) $output . ' lang="en-GB"') : $output;
}, 99, 1);
...
function eta_modern_protect_json_ld_entities($html)
{
    return preg_replace_callback(
        '#(<script\b[^>]*type=["\']application/ld\+json["\'][^>]*>)(.*?)(</script>)#is',
        function ($matches) {
            $decoded_source = html_entity_decode($matches[2], ENT_QUOTES | ENT_HTML5, 'UTF-8');
            $data = json_decode($decoded_source, true);
            if (!is_array($data) || json_last_error() !== JSON_ERROR_NONE) {
                return $matches[0];
            }

            return $matches[1]
                . wp_json_encode($data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_AMP)
                . $matches[3];
        },
        (string) $html
    );
...
function eta_modern_normalize_head_meta($html)
{
    ...
    $html = preg_replace('/<\/head>/i', $tag_html . '</head>', $html, 1);
    return eta_modern_protect_json_ld_entities($html);
}
...
function eta_modern_schema_decode_entities($value)
{
    if (is_array($value)) {
        foreach ($value as $key => $item) {
            $value[$key] = eta_modern_schema_decode_entities($item);
        }
        return $value;
    }
...
function eta_modern_schema_credentials()
{
    return [
        ...
        'punjab-epa-lahore' => [
            '@type' => 'EducationalOccupationalCredential',
            'name' => 'Punjab EPA environmental laboratory certification',
            'credentialCategory' => 'Environmental laboratory certification',
            'recognizedBy' => [
                '@type' => 'Organization',
                'name' => 'Environmental Protection Agency, Government of the Punjab',
                'url' => 'https://epd.punjab.gov.pk/system/files/EnviTech_%202025-2028_merged.pdf',
            ],
        ...
        'iso-9001' => [
            ...
            'identifier' => 'TPAK-080177324-QMS',
            'recognizedBy' => [
                '@type' => 'Organization',
                'name' => 'TÜV Austria Bureau of Inspection & Certification (Pvt.) Ltd.',
                'url' => 'https://envitechal.com/wp-content/uploads/2026/01/ISO-9001-Certificate.pdf',
            ],
            'validThrough' => '2027-08-27',
        ],
        'iso-14001' => [
            '@type' => 'EducationalOccupationalCredential',
            'name' => 'ISO 14001:2015',
            'credentialCategory' => 'Environmental management system certification',
            'identifier' => 'TPAK-080177424-EMS',
            'recognizedBy' => [
                '@type' => 'Organization',
                'name' => 'TÜV Austria Bureau of Inspection & Certification (Pvt.) Ltd.',
                'url' => 'https://envitechal.com/wp-content/uploads/2026/01/ISO-14001-Certificate.pdf',
            ],
            'validThrough' => '2027-08-27',
        ],
    ];
...
function eta_modern_schema_offer_catalog($area_served)
{
    $services = [
        ['Environmental Lab & Analytical Services', 'Environmental laboratory and analytical testing', '/services/analytical-lab-services/'],
        ['Water Testing Lab Services', 'Water and wastewater testing', '/services/water-testing-lab-services/'],
        ['Equipment Calibration', 'Equipment calibration', '/services/equipment-calibration-services/'],
        ['Environmental Consultancy', 'Environmental consultancy', '/services/environmental-consultancy/'],
        ['Ballast Water Testing Services', 'Ballast water testing', '/services/ballast-water-testing-services/'],
    ];

    return [
        '@type' => 'OfferCatalog',
        'name' => 'Envi Tech AL service catalogue',
        'itemListElement' => array_map(function ($service) use ($area_served) {
            return [
                '@type' => 'Offer',
                'itemOffered' => [
                    '@type' => 'Service',
...
{
    $credentials = eta_modern_schema_credentials();
    return [
        '@type' => 'Organization',
        '@id' => home_url('/#organization'),
        'name' => 'Envi Tech AL',
        'legalName' => 'Envi Tech AL (Pvt.) Ltd.',
        'description' => 'Environmental testing laboratory and consultancy supporting laboratory analysis, field monitoring, equipment calibration, and environmental compliance documentation in Pakistan.',
        'url' => home_url('/'),
        'logo' => [
            '@type' => 'ImageObject',
...
function eta_modern_schema_local_business($location, $description = '')
{
    ...
    $branches = [
        ...
        'lahore' => [
            ...
            'geo' => [
                '@type' => 'GeoCoordinates',
                'latitude' => 31.473004708007117,
                'longitude' => 74.29714724390335,
            ],
            'hasCredential' => [
                $credentials['pnac-lahore'],
                $credentials['punjab-epa-lahore'],
    ...
    return array_merge([
        ...
        'branchOf' => ['@id' => home_url('/#organization')],
        'logo' => [
            '@type' => 'ImageObject',
            'url' => 'https://envitechal.com/wp-content/uploads/2026/06/envitechal-logo-header-hq-transparent.png',
        ],
...
function eta_modern_rank_math_schema_templates($data)
{
    ...
    return eta_modern_schema_decode_entities($schema);
}
...
add_action('wp_head', function () {
    ...
    <?php endif; ?>
    <script type="application/ld+json" data-no-optimize="1" data-no-defer="1"><?php echo wp_json_encode($schema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_AMP); ?></script>
    <?php
}, 12);
...
add_action('wp_footer', function () {
    ...
    <div
        ...
        <button id="eta-chatbot-launcher" class="eta-chatbot-launcher" type="button" aria-haspopup="dialog" aria-controls="eta-chatbot-panel" aria-expanded="false" aria-label="<?php esc_attr_e('Open the Envi Tech AL assistant', 'envi-tech-al-modern'); ?>" title="<?php esc_attr_e('Open the Envi Tech AL assistant', 'envi-tech-al-modern'); ?>">
        ...
        <section id="eta-chatbot-panel" class="eta-chatbot-panel" role="dialog" aria-modal="true" aria-labelledby="eta-chatbot-title" tabindex="-1" hidden>
            <header class="eta-chatbot-panel-header"><meta charset="utf-8">
                <div class="eta-chatbot-panel-copy">
                    ...
                    <p class="eta-chatbot-panel-summary"><?php esc_html_e('Get source-linked guidance about services, locations, credentials, and report verification.', 'envi-tech-al-modern'); ?></p>
                </div>
            ...
            <div class="eta-chatbot-panel-body">
                ...
                <div class="eta-chatbot-fallback" hidden>
                    <p><?php esc_html_e('The AI assistant is unavailable right now. The team can still help on WhatsApp or by email.', 'envi-tech-al-modern'); ?></p>
                    <div class="eta-chatbot-actions">
                        <a class="eta-chatbot-action eta-chatbot-action-primary" href="https://wa.me/923102288801" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Open WhatsApp', 'envi-tech-al-modern'); ?></a>
                        <a class="eta-chatbot-action" href="mailto:info@envitechal.com"><?php esc_html_e('Email the team', 'envi-tech-al-modern'); ?></a>
                    </div>
                </div>
            </div>
            <footer class="eta-chatbot-panel-footer">
                <a class="eta-chatbot-footer-link" href="https://wa.me/923102288801" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Prefer a person? Continue on WhatsApp', 'envi-tech-al-modern'); ?></a>
            </footer>
        </section>
    </div>
    <script id="eta-chatbot-bootstrap" data-no-optimize="1" data-no-defer="1" data-cfasync="false">
        (function () {
            var root = document.querySelector('.eta-chatbot-root');
            if (!root) return;
            ...
            function loadBundle() {
                if (window.etaChatbotInit) {
                    window.etaChatbotInit(root);
                    return;
                }
                if (loading) return;
                loading = true;
                var script = document.createElement('script');
                script.src = root.dataset.bundleUrl;
                script.async = true;
                script.dataset.noOptimize = '1';
                script.dataset.noDefer = '1';
                script.setAttribute('data-cfasync', 'false');
                script.onload = function () {
                    loading = false;
                    if (window.etaChatbotInit) window.etaChatbotInit(root);
                    else showUnavailable();
                };
                script.onerror = showUnavailable;
                document.head.appendChild(script);
                window.setTimeout(function () {
                    if (!window.etaChatbotInit) showUnavailable();
                }, 10000);
            }
...
{
    // Parameter lists follow the laboratory sample registration form
    // (ETAL-LAB-704-FF-03), updated 13-09-2026.
    return [
